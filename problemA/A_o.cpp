	...
	for(int startNode=0;startNode<uniqStops.size();startNode++)
	{
		...
		for(int endNode=(startNode+1);endNode<uniqStops.size();endNode++)
		{
			...
			for(int testrun=0;testrun<10;testrun++)
			{
					...
					//simple swapping
					// for(int opti=0;opti<10000;opti++)
					// {
					// 	int v1change= rand() % v1s;
					// 	int v1change_1 = rand() % v1s;
					// 	if(v1change_1==v1change)
					// 	{
					// 		continue;
					// 	}
					// 	int v2match= matching1[v1change];
					// 	int v2match_1 = matching1[v1change_1];
					// 	if(weightVec[v1change][v2match_1]==INT_MAX || weightVec[v1change_1][v2match]==INT_MAX ||
					// 	weightVec[v1change_1][v2match_1]==INT_MAX || weightVec[v1change][v2match]==INT_MAX )
					// 	{
					// 		continue;
					// 	}
					// 	int addn=weightVec[v1change][v2match_1]+weightVec[v1change_1][v2match];
					// 	int subn=weightVec[v1change][v2match]+weightVec[v1change_1][v2match_1];
					// 	if(addn>subn)
					// 	{
					// 		continue;
					// 	}
					// 	scoring=(scoring-subn+addn);
					// 	matching1[v1change]=v2match_1;
					...
					// 	for(int z=0;z<v2s;z++)
					// 	{
					// 		if(weightVec[v1change][v2match]<weightVec[v1change][z])
					// 		{
